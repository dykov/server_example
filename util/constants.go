...
const RabbitmqConnectionFailed = "RabbitMQ connection failed "
const SuccessfulConnectionToRabbitmq = "Successful connection to RabbitMQ "
...
const UnknownActionType = "Unknown action type "
const UnknownEntityType = "Unknown entity type "
...
const DirPhotos = "./files"
const DirLog = "./log"
const DirServerLog = "/placard_server."
const DirHttpLog = "/placard_http_request."
...
var ActionType = map[string]uint64{
	"create": 0,
	"update": 1,
	"delete": 2,
}
...
const (
	...
	EntityEvent     = "event"
	EntityOrganizer = "organizer"
	EntityCategory  = "category"
	EntityReport    = "report"
)

var EntityType = map[string]uint64{
	"city":      0,
	"location":  1,
	"event":     2,
	"organizer": 3,
